...
console.log(__WEBPACK_IMPORTED_MODULE_1__person_js__["b" /* isAdult */](12, 18));
console.log(__WEBPACK_IMPORTED_MODULE_1__person_js__["a" /* canDrink */](21, 18));
...
console.log(`Running from utils.js !!`)
...
const isAdult = (age, allowedAge) => age >= allowedAge;
/* harmony export (immutable) */ __webpack_exports__["b"] = isAdult;


const canDrink = (age, allowedAge) => age >= allowedAge;
